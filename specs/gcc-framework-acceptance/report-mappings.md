...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `ppvs_checkoutrequest` | Active Checkout Requests | View | Review app entry point and dashboard drill-through | `ppvs_requestnumber`, `ppvs_labassetid`, `ppvs_lifecyclestage`, `ppvs_expectedreturndate` | Which requests require action? | Lab operations owner | Named view resolves; active rows display; record drill-through works |
...
| `ppvs_labasset` | Available Lab Assets | View | Review app and dashboard drill-through | `ppvs_assettag`, `ppvs_category`, `ppvs_availabilitystatus` | Which assets can be issued? | Lab operations owner | Available filter works; asset drill-through opens the main form |
